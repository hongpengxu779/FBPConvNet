...
def main(config):
    ...
    optimizer = torch.optim.Adam(fbp_conv_net.parameters(), lr=learning_rate[0],
                                 weight_decay=1e-8)
    epoch_start = 0
...
if __name__ == '__main__':
    ...
    parser.add_argument('--learning_rate', type=tuple, default=np.logspace(-3, -5, 151))
    parser.add_argument('--grad_max', type=float, default=0.1)
    parser.add_argument('--batch_size', type=int, default=4)
    parser.add_argument('--data_path', type=str, default='preproc_sparseview_50_forbild_full720.mat')
